<!-- Footer -->
<footer class="bg3 p-t-75 p-b-32 footer-color">
    <div class="container">
        <div class="row">
        ...
        <div class="p-t-40">
            ...
            <p class="stext-107 cl6 txt-center">
                ...
                </script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://www.facebook.com/chunghiepkunn12" target="_blank">Lê Thành Nghiệp</a> &amp; distributed by <a href="https://themewagon.com" target="_blank">ThemeWagon</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
