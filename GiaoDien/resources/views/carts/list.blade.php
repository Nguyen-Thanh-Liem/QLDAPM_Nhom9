...
<form class="bg0 p-t-130 p-b-85" method="post">
    ...
    <!-- nếu giỏ hàng có sản phẩm mới in ra -->
    @if (count($products) != 0)
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                    ...
                    <div class="flex-w flex-t p-t-27 p-b-33">
                        ...
                        <div class="size-209 p-t-1">
                            <span class="mtext-110 cl2">
                                {{ number_format($total - (Session::get('discount.value') ?? 0), 0, '', '.') }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div>
                        <span class="cl2">
                            Mã giảm giá: {{ Session::get('discount.code') }} (-{{ number_format(Session::get('discount.value'), 0, '', '.') }})
                        </span>
                    </div>
                    @endif
                    ...
                    <div class="bor8 bg0 m-b-22">
                        <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="discount_code" placeholder="Nhập mã giảm giá">
                    </div>

                    <div class="flex-c-m stext-101 cl2 size-118 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer">
                        <input type="submit" value="Áp dụng mã giảm giá" formaction="/apply-discount" class="cl2 bg8 pointer border-0">
                    </div>
